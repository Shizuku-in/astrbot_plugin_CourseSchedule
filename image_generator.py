...
class ImageGenerator:
    ...
    def __init__(self, generated_by_name: str = "Emi", timezone_offset_hours: int = 8):
        self.generated_by_name = generated_by_name.strip() if generated_by_name and generated_by_name.strip() else "Emi"
        self.generated_by_text = f"Generated by {self.generated_by_name}"
    ...
    async def generate_ranking_image(
        ...
        # 右下角」
        right_x = c.RANKING_WIDTH - bracket_margin
        bottom_y = height - bracket_margin
        draw.rectangle(
            [
                right_x - bracket_thickness,
